...
profile.save_csv("outputs/variography_profiles/drum_profile_00001.csv")
profile.save_mat("outputs/variography_profiles/drum_profile_00001.mat")
```
...
config = BatchConfig(
    profiles_dir="../../../outputs/variography_profiles/test_batch",
    out_dir="../../../outputs/sim_profiles/test_batch",
)
