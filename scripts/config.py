...
BATCH_NUMBER       = 8
SEED               = 654    # avoid duplicate drum profiles across batches, but ensure reproducibility
PLOT_BATCH_NUMBERS = [8]
...
STEADY_STATE = {
    ...
    "n": 1.0,
    "rho_dollars": 0.0,
    "T_steam_out": 504.40692106190926,
    "x_steam_out": 1.0,
    "drumAngleDeg": 45.0,
}
